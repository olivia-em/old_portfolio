...
<div class="olivia"> 
<img class="logo" src="{{ "/assets/2decb767-8051-4237-974a-927409aa4233-stars1040invert.png" | url }}">
...
<div class="nav proj">
    ...
    <h3><a href="{{ '/posts/design' | url }}" >Static Design</a></h3>
    <h3><a href="#" class="filter-btn" data-filter="all">All Projects</a></h3>
</div>

<div class="nav"> 
<h3><a href="{{ '/about' | url }}">> About</a></h3>
...
<h5 class="btw">* I built this site using HTML/CSS & Eleventy.js!</h5>
</div>
